...
class HrHolidaysPublic(models.Model):
    ...
    public_holiday = fields.Boolean('Public Holiday', default=False, help="If the Leave if a Government defined Leave")
    qpr_holiday = fields.Boolean('Official Declare Holiday', default=False, help="If the Leave if a QPR Announce Leave")
